    ...
    if (vue === "pointage") {
        ...
        <SafeAreaView style={styles.safe}>
            ...
            {departements.map(d => (
                <Pressable
                key={d.id}
                style={[styles.deptPill, filtreDept === d.id && styles.deptPillActif]}
                onPress={() => setFiltreDept(filtreDept === d.id ? null : d.id)}
                >
                <Text style={[styles.deptPillText, filtreDept === d.id && styles.deptPillTextActif]}>
                    {d.nom}
                </Text>
                </Pressable>
            ))}
            ...
            {membresFiltres.map(m => {
                ...
                <Pressable
                    key={m.id}
                    style={[styles.membreRow, present && styles.membreRowPresent]}
                    onPress={() => togglePresence(m.id)}
                >
            ...
            <Pressable
                style={[styles.btnSauvegarder, sauvegarde && { opacity: 0.6 }]}
    ...
    if (vue === "historique") {
        ...
        <SafeAreaView style={styles.safe}>
            ...
            {chargementHistorique ? (
                ...
                <Text style={styles.videTexte}>Aucun historique trouvé.</Text>
            ) : (
