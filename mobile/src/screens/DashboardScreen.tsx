      ...
      return (
        <ScrollView style={s.contenu} contentContainerStyle={{ padding: 16, paddingBottom: 100 }}>
          ...
          <Pressable style={s.moduleCard} onPress={() => setSousModule("profil")}>
            <View style={s.moduleIconeBox}><Ionicons name="person-outline" size={22} color="#07074C" /></View>
            <View style={{ flex: 1 }}><Text style={s.moduleNom}>Mon profil</Text><Text style={s.moduleSub}>Modifier mes informations</Text></View>
          ...
          {peutVoir("visiteurs") && (
            <Pressable style={s.moduleCard} onPress={() => setSousModule("visiteurs")}>
              ...
              <View style={{ flex: 1 }}><Text style={s.moduleNom}>Visiteurs</Text><Text style={s.moduleSub}>Suivi des nouveaux arrivants</Text></View>
              <Ionicons name="chevron-forward" size={18} color="#CBD5E0" />
            </Pressable>
          )}
          ...
          {peutVoir("departements") && (
            <Pressable style={s.moduleCard} onPress={() => setSousModule("departements")}>
              ...
              <View style={{ flex: 1 }}><Text style={s.moduleNom}>Départements</Text><Text style={s.moduleSub}>Gérer les départements</Text></View>
              <Ionicons name="chevron-forward" size={18} color="#CBD5E0" />
            </Pressable>
          )}
          ...
          {peutVoir("rapports") && (
            <Pressable style={s.moduleCard} onPress={() => setSousModule("rapports")}>
              ...
              <View style={{ flex: 1 }}><Text style={s.moduleNom}>Rapports</Text><Text style={s.moduleSub}>Statistiques et exports</Text></View>
              <Ionicons name="chevron-forward" size={18} color="#CBD5E0" />
            </Pressable>
          )}
          ...
          <Pressable style={s.moduleCard} onPress={() => setSousModule("croissance")}>
            ...
            <View style={{ flex: 1 }}><Text style={s.moduleNom}>Croissance</Text><Text style={s.moduleSub}>Statistiques sur 12 mois</Text></View>
            <Ionicons name="chevron-forward" size={18} color="#CBD5E0" />
          </Pressable>
          ...
          <Pressable style={s.moduleCard} onPress={() => setSousModule("pastoral")}>
            ...
            <View style={{ flex: 1 }}><Text style={s.moduleNom}>Suivi pastoral</Text><Text style={s.moduleSub}>Notes confidentielles sur les membres</Text></View>
            <Ionicons name="chevron-forward" size={18} color="#CBD5E0" />
          </Pressable>
          ...
          <Pressable style={s.moduleCard} onPress={() => setSousModule("budget")}>
            ...
            <View style={{ flex: 1 }}><Text style={s.moduleNom}>Budget annuel</Text><Text style={s.moduleSub}>Planification et suivi budgétaire</Text></View>
            <Ionicons name="chevron-forward" size={18} color="#CBD5E0" />
          </Pressable>
          ...
          <Pressable style={s.moduleCard} onPress={() => setSousModule("calendrier")}>
            ...
            <View style={{ flex: 1 }}><Text style={s.moduleNom}>Calendrier</Text><Text style={s.moduleSub}>Activités et événements</Text></View>
            <Ionicons name="chevron-forward" size={18} color="#CBD5E0" />
          </Pressable>
          ...
          <Pressable style={s.moduleCard} onPress={() => setSousModule("chat")}>
            ...
            <View style={{ flex: 1 }}><Text style={s.moduleNom}>ChatIntimacy</Text><Text style={s.moduleSub}>Messagerie interne</Text></View>
          ...
          <Pressable style={s.moduleCard} onPress={() => setSousModule("notifications")}>
            ...
            <View style={{ flex: 1 }}><Text style={s.moduleNom}>Notifications</Text><Text style={s.moduleSub}>Alertes et rappels</Text></View>
...
const s = StyleSheet.create({
  ...
  sectionTitre: { fontSize: 16, fontWeight: "700", color: "#1E293B" },
  ...
  moduleCard: { backgroundColor: "#fff", borderRadius: 14, padding: 14, flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 10, borderWidth: 0.5, borderColor: "#E2E8F0" },
